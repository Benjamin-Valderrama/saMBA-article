...
The scripts in this repository were used to analyse the saMBA count tables generated by using the workflow described in the GitHub repository ['saMBA-pipeline'](https://github.com/Benjamin-Valderrama/saMBA-pipeline). Read the associated wiki for an in-depth discussion about how the workflow operates. If you are interested in replicating the analysis, you could use that workflow to build saMBA in your own machine. Alternatively, you could download the outputs we generated with that workflow and shared in the associated [Zenodo repository](https://zenodo.org/records/15050380). 
